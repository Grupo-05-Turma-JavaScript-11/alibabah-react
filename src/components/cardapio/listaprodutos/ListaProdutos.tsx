        ...
        <div className="bg-gradient-to-b from-[#7A1E2D] via-[#3B2F2F] to-[#1A1A1A] min-h-screen py-20 px-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="text-center mb-24">
                    <h1 className="text-[8rem] leading-none font-black text-transparent bg-clip-text bg-gradient-to-b from-[#D4AF37] to-[#7A1E2D] opacity-20 absolute left-0 right-0 select-none">ALIBABAH</h1>
                    <h2 className="text-6xl font-black text-[#F3E9DC] relative pt-12">Nosso Cardápio</h2>
