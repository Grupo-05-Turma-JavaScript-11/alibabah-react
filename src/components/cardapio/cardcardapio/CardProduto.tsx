    ...
    return (
        ...
        <div className="col-span-full w-full min-h-[500px] flex flex-col lg:flex-row bg-[#FAFAF8] rounded-[3rem] shadow-[0_30px_100px_rgba(0,0,0,0.4)] border-4 border-[#D4AF37] overflow-hidden animate-in fade-in zoom-in duration-500">
            ...
            <div className="lg:w-1/2 h-80 lg:h-auto relative">
                <img src="https://images.unsplash.com/photo-1541529086526-db283c563270?q=80&w=800" className="w-full h-full object-cover" />
                <div className="absolute top-6 left-6 flex gap-3">
                    <button className="px-6 py-2 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:scale-105 transition-transform">EDITAR</button>
                    <button className="px-6 py-2 bg-red-600 text-white font-bold rounded-full shadow-lg hover:scale-105 transition-transform">EXCLUIR</button>
                </div>
            </div>
            ...
            <div className="lg:w-1/2 p-12 flex flex-col justify-between bg-white">
                <div className="relative">
                    ...
                    <h2 className="text-5xl font-black text-[#7A1E2D] my-4 leading-none">Kibe Montado Especial</h2>
                    <p className="text-[#3B2F2F] text-xl leading-relaxed italic border-l-4 border-[#D4AF37] pl-6 my-8">
                        "Receita secular da família Alibabah, com carnes selecionadas e especiarias importadas diretamente do Oriente Médio."
                    </p>
                </div>

                <div className="flex items-center justify-between mt-8 border-t-2 border-[#F3E9DC] pt-8">
                    <div className="text-4xl font-black text-[#3B2F2F]">R$ 32,00</div>
