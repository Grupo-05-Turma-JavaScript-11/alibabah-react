  ...
  if (!expandido) {
    return (
      ...
      <div className="group relative w-full h-[450px] bg-[#3B2F2F] rounded-[2rem] overflow-hidden shadow-2xl border-2 border-[#D4AF37]/20 transition-all hover:border-[#D4AF37]">
        <img
          src="https://images.unsplash.com/photo-1541529086526-db283c563270?q=80&w=800"
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#3B2F2F] via-[#3B2F2F]/20 to-transparent p-8 flex flex-col justify-end">
          <h3 className="text-[#F3E9DC] font-black text-3xl mb-4 tracking-tighter">
            KIBE MONTADO
          </h3>
          <button
      ...
      <div className="lg:w-1/2 h-80 lg:h-auto relative">
        ...
        <div className="absolute top-6 left-6 flex gap-3">
          <Link
            ...
            className="px-6 py-2 bg-blue-600 text-white font-bold rounded-full shadow-lg hover:scale-105 transition-transform"
          >
          ...
          <Link
            ...
            className="px-6 py-2 bg-red-600 text-white font-bold rounded-full shadow-lg hover:scale-105 transition-transform"
          >
      ...
      <div className="lg:w-1/2 p-12 flex flex-col justify-between bg-white">
        <div className="relative">
          <button
            ...
            className="absolute -top-4 -right-4 text-5xl text-[#7A1E2D] font-light"
          >
            &times;
          </button>
          ...
          <h2 className="text-5xl font-black text-[#7A1E2D] my-4 leading-none">
            {produto.nome}
          </h2>
